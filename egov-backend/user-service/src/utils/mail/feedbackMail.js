...
module.exports = {
    feedbackMail: async (email, htmlContent) => {
                ...
                <tr>
                    <td align="center" valign="top">
                        <table width="600" border="0" align="center" cellpadding="0" cellspacing="0">
                            ...
                            <tr>
                                <td bgcolor="#ffffff">
                                    <table width="90%" border="0" cellpadding="0" cellspacing="0" align="center">
                                        ...
                                        <tr>
                                            <td align="left"
                                                style="font-family:Montserrat,sans-serif; font-size:16px; line-height:20px; color:#707070; padding:10px 20px;">
                                                ${htmlContent}
                                            </td>
                                        </tr>
                                        <tr>
                                            <td align="left"
                                                style="font-family:Montserrat,sans-serif; font-size:16px; line-height:20px; padding:10px 20px;">
                                                Best Regards,
                                            </td>
                                        </tr>
                                        <tr>
                                            <td align="left"
                                                style="font-family:Montserrat,sans-serif; font-size:16px; line-height:20px; padding:0 20px 10px;">
                                                eGov
                                            </td>
                                        </tr>
                                    </table>
                            ...
                            <tr>
                                <td height="2" align="left" valign="middle" bgcolor="#dcdcdc"></td>
                            </tr>
                            <tr>
                                    ...
                                    <table width="90%" border="0" align="center" cellpadding="0" cellspacing="0">
                                        <tr>
                                            <td align="center" valign="middle"
                                                style="font-family:Montserrat,sans-serif; font-size:14px; line-height:16px; font-weight:400; color:#707070; padding:10px;">
    ...
    systemSupportMail: async (email, htmlContent) => {
        let setting = await generalsettingModal.findAll({ raw: true });
        const extractedSettings = setting.reduce((acc, setting) => {
            acc[setting.settingKey] = setting.settingValue;
            return acc;
        ...
        const toEmail = ""; // Define To Email Id and please note that if multiple email addresses then pass comma separated.
        const ccEmail = ""; // Define CC Email Id and please note that if multiple email addresses then pass comma separated.
        const bccEmail = ""; // Define BCC Email Id and please note that if multiple email addresses then pass comma separated.

        const emailParams = {
        EmailTo: email || "",
        Subject: "Request for need support for admin",
        Message: `
        <!DOCTYPE html>
        <html>
