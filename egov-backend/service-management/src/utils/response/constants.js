exports.MESSAGES = {
  ...
  FORMBUILDER: {
    FORMBUILDER_ADDED: "form added successfully",
    FORMBUILDER_ID_NOT_FOUND: "Please enter form id",
    FORMBUILDER_UPDATE: "Form updated successfully",
    FORMBUILDER_UPDATE_FAILED: "Failed to update form ",
    FORMBUILDER_FETCH: "Form fetched successfully",
    FORMBUILDER_FETCH_FAILED: "Failed to fetch form list",
    FORMBUILDER_DELETE: "Form deleted successfully",
    FORMBUILDER_DELETE_FAILED: "Failed to delete form"
  },
  DEPARTMENT: {
