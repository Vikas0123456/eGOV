...
const ServicePerformanceByUser = () => {
    ...
    const excelReportExport = async () => {
        ...
        try {
            const response = await axiosInstance.post(
                `departmentReport/agentPerformance/exportToExcel`,
                {
            ...
            fetch(`${response?.data?.data?.result}`)
                ...
                .then(async (blob) => {
                    ...
                    await axiosInstance.post(
                        `departmentReport/agentPerformance/removeExcel`,
                        {
                            fileName: fileName,
                        }
                    );
    ...
    const pdfReportExport = async () => {
        ...
        try {
            const response = await axiosInstance.post(
                `departmentReport/agentPerformance/generateDeptPdf`,
                {
                    serviceSlug: serviceSlug,
                    dateRange: {
            ...
            fetch(`${response?.data?.data?.result}`)
                ...
                .then((blob) => {
                    ...
                    const result = axiosInstance.post(
                        `departmentReport/agentPerformance/removeDeptPdf`,
                        {
                            fileName: fileName,
                        }
                    );
    ...
    const getServiceReport = async () => {
        try {
            setLoading(true);
            const response = await axiosInstance.post(
                `departmentReport/agentPerformance/list`,
                {
                    page: currentPage,
                    perPage: perPageSize,
...
export default ServicePerformanceByUser;
