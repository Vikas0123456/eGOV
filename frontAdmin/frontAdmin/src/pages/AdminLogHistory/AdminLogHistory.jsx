...
const AdminLogHistory = () => {
    ...
    const FeedbackPermissions =
        ...
        userPermissionsDecryptData?.data?.find(
            (module) => module.slug === "adminLogHistory"
        );
    ...
    const tableName = "adminLogHistory";
    ...
    const searchLogList = async () => {
        try {
            ...
            const response = await axiosInstance.post(
                "userService/user/login-history/view",
                {
                    page: currentPage,
                    perPage: perPageSize,
    ...
    document.title = "Admin Log History | eGov Solution";
                                    ...
                                    <div className="page-title-box header-title d-sm-flex align-items-center justify-content-between pt-lg-4 pt-3">
                                        <Dropdown className="card-header-dropdown">
                                            <Dropdown.Toggle
                                                variant="link"
                                                id="dropdown-basic"
                                                className="dropdown-btn h4 text-black cursor-pointer py-0">
                                                Admin Log Report{" "}
                                ...
                                <div className="col-xxl-12">
                                    <div className="card border-0">
                                        <div className="card-body border-0 ">
                                            <div className="row">
                                                <div className="col-xl-4 col-lg-4 col-md-4 col-sm-6  col-xxl-2 mb-3 mb-md-0 mb-lg-0">
                                                ...
                                                <div className="col-xl-4 col-lg-4 col-md-4 col-sm-6  col-xxl-2 mb-3 mb-sm-0   mb-md-3 mb-lg-3 mb-xl-3 mb-xxl-0 ">
                                                            ...
                                                            {isLoading ? (
                                                                ...
                                                                <tr>
                                                                    <td
                                                                        ...
                                                                        className="text-center">
                                                                        <NotFound
                                                                            heading="Admin Log Report not found."
                                                                            message="Unfortunately, admin log report not available at the moment."
                                                                        />
                                                                    </td>
                                                                </tr>
                                                            ) : (
                                                                            ...
                                                                            {columns.includes(
                                                                                "Type"
                                                                                    ...
                                                                                    <td>
                                                                                        <Badge
                                                                                            bg={
                                                                                                adminLogHistory.isLoginSuccess ===
                                                                                                    "0"
                                                                                                    ? "danger"
                                                                                                    : adminLogHistory.isLoginSuccess ===
                                                                                                        "1"
