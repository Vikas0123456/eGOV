        ...
        <React.Fragment>
            <div className="page-content">
                <Container fluid>
                    <Row>
                        <Col lg={12}>
                            <Card className="rounded-0 rounded-0 bg-primary-subtle mx-n4 mt-n4 border-0">
                                <div className="px-4">
                                    <Row>
                                        <Col xxl={5} className="align-self-center">
                                            <div className="py-4">
                                                <h4 className="display-6 coming-soon-text">Frequently asked questions</h4>
                                                <p className="text-muted fs-15 mt-3">If you can not find answer to your question in our FAQ, you can always contact us or email us. We will answer you shortly!</p>
                                        ...
                                        <div className="accordion accordion-border-box" id="genques-accordion">
                                            <div className="accordion-item">
                                                <h2 className="accordion-header" id="genques-headingOne">
                                                    <button className={classnames("accordion-button cursor-pointer", "fw-medium", { collapsed: !col1 })} type="button" onClick={t_col1}  >
                                                        What is Lorem Ipsum ?
                                                    </button>
                                                </h2>
                                            ...
                                            <div className="accordion-item">
                                                <h2 className="accordion-header" id="genques-headingTwo">
                                                    <button className={classnames("accordion-button cursor-pointer", "fw-medium", { collapsed: !col2 })} type="button" onClick={t_col2} >
                                                        Why do we use it ?
                                                    </button>
                                                </h2>
                                            ...
                                            <div className="accordion-item">
                                                <h2 className="accordion-header" id="genques-headingThree">
                                                    <button className={classnames("accordion-button cursor-pointer", "fw-medium", { collapsed: !col3 })} type="button" onClick={t_col3}  >
                                            ...
                                            <div className="accordion-item">
                                                <h2 className="accordion-header" id="genques-headingFour">
                                                    <button className={classnames("accordion-button cursor-pointer", "fw-medium", { collapsed: !col4 })} type="button" onClick={t_col4} >
                                        ...
                                        <div className="accordion accordion-border-box" id="manageaccount-accordion">
                                            <div className="accordion-item">
                                                <h2 className="accordion-header" id="manageaccount-headingOne">
                                                    <button className={classnames("accordion-button cursor-pointer ", "fw-medium", { collapsed: !col5 })} type="button" onClick={t_col5} >
                                                        Where can I get some ?
                                                    </button>
                                                </h2>
                                            ...
                                            <div className="accordion-item">
                                                <h2 className="accordion-header" id="manageaccount-headingTwo">
                                                    <button className={classnames("accordion-button cursor-pointer", "fw-medium", { collapsed: !col6 })} type="button" onClick={t_col6} >
                                                        Where does it come from ?
                                                    </button>
                                                </h2>
                                            ...
                                            <div className="accordion-item">
                                                <h2 className="accordion-header" id="manageaccount-headingThree">
                                                    <button className={classnames("accordion-button cursor-pointer", "fw-medium", { collapsed: !col7 })} type="button" onClick={t_col7} >
                                                        Why do we use it ?
                                                    </button>
                                                </h2>
                                            ...
                                            <div className="accordion-item">
                                                <h2 className="accordion-header" id="manageaccount-headingFour">
                                                    <button className={classnames("accordion-button cursor-pointer", "fw-medium", { collapsed: !col8 })} type="button" onClick={t_col8} >
                                                        What is Lorem Ipsum ?
                                                    </button>
                                                </h2>
                                        ...
                                        <div className="accordion accordion-border-box" id="privacy-accordion">
                                            <div className="accordion-item">
                                                <h2 className="accordion-header" id="privacy-headingOne">
                                                    <button className={classnames("accordion-button cursor-pointer", "fw-medium", { collapsed: !col9 })} type="button" onClick={t_col9} >
                                                        Why do we use it ?
                                                    </button>
                                                </h2>
                                            ...
                                            <div className="accordion-item">
                                                <h2 className="accordion-header" id="privacy-headingTwo">
                                                    <button className={classnames("accordion-button cursor-pointer", "fw-medium", { collapsed: !col10 })} type="button" onClick={t_col10} >
                                                        Where can I get some ?
                                                    </button>
                                                </h2>
                                            ...
                                            <div className="accordion-item">
                                                <h2 className="accordion-header" id="privacy-headingThree">
                                                    <button className={classnames("accordion-button cursor-pointer", "fw-medium", { collapsed: !col11 })} type="button" onClick={t_col11} >
                                                        What is Lorem Ipsum ?
                                                    </button>
                                                </h2>
                                            ...
                                            <div className="accordion-item">
                                                <h2 className="accordion-header" id="privacy-headingFour">
                                                    <button className={classnames("accordion-button cursor-pointer", "fw-medium", { collapsed: !col12 })} type="button" onClick={t_col12} >
                                                        Where does it come from ?
                                                    </button>
                                                </h2>
