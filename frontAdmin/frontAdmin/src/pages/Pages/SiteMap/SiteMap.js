...
const SiteMap = () => {
    document.title = "SiteMap | eGov solution";
    return (
        <div>
                                            ...
                                            <div className="verti-sitemap">
                                                <ul className="list-unstyled mb-0">
                                                    ...
                                                    <li>
                                                        ...
                                                        <div className="first-list">
                                                            <div className="list-wrap">
                                                                <Link to="#" className="fw-medium text-primary">Mary Jones - Project Manager</Link>
                                                            </div>
                                                            <ul className="second-list list-unstyled">
                                                                ...
                                                                <li><Link to="#">Walter Newman - Frontend Developer</Link>
                                                                </li>
                                                        ...
                                                        <div className="first-list">
                                                            <div className="list-wrap">
                                                                <Link to="#" className="fw-medium text-primary">Rachel Rose- HR</Link>
                                                            </div>
                                                        </div>
                                                    </li>
                                                </ul>
