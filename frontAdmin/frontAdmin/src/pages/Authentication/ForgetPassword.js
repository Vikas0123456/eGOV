                ...
                <CardBody className="p-4">
                  <div className="text-center mt-2">
                    ...
                    <lord-icon src="https://cdn.lordicon.com/rhvddzym.json"
                      trigger="loop" colors="primary:#00bd9d" className="avatar-xl" style={{ width: "120px", height: "120px" }} >
                    </lord-icon>
                  ...
                  <div className="p-2">
                    {forgetError && forgetError ? (
                      <Alert color="danger" className="fs-13" >
                        {forgetError}
                      </Alert>
                    ) : null}
                    {forgetSuccessMsg ? (
                      <Alert color="success" className="fs-13">
                        {forgetSuccessMsg}
                      </Alert>
                    ) : null}
