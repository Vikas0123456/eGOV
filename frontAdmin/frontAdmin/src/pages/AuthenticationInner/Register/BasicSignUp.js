...
import { Card, CardBody, Col, Container, Row, FormFeedback, Input, Button } from 'reactstrap';
...
const BasicSignUp = () => {
    document.title = "Dashboard Template";
                                            ...
                                            <form className="needs-validation" action="#">
                                                ...
                                                <div className="mt-4 text-center">
                                                    ...
                                                    <div>
                                                        ...
                                                        <button type="button" className="btn btn-primary btn-icon waves-effect waves-light"><i className="ri-github-fill fs-16"></i></button>{" "}
