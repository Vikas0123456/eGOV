        ...
        <React.Fragment>
            <Dropdown isOpen={isProfileDropdown} toggle={toggleProfileDropdown} className="ms-sm-3 header-item topbar-user">
                <DropdownToggle tag="button" type="button" className="btn">
                    <span className="d-flex align-items-center">
                        ...
                        <p className="avatar-sm bg-primary mb-0 rounded-circle fs-20 text-white d-flex align-items-center justify-content-center">
                            <i className="fst-normal fw-bold">
                                {userData?.name && firstLetter(userData?.name)}
                            </i>
                        </p>
                        </div>    
                ...
                <DropdownMenu className="dropdown-menu-end">
                    ...
                    <DropdownItem className='p-0'>
                        <Link to="/admin-log-report" className="dropdown-item">
                            <i className="mdi mdi-calendar-check-outline text-muted fs-16 align-middle me-1"></i> <span
                                className="align-middle">Log History</span>
                        </Link>
                    </DropdownItem>
                    <DropdownItem className='p-0'>
                        <Link to="/email-log" className="dropdown-item">
                            <i className="mdi mdi-calendar-check-outline text-muted fs-16 align-middle me-1"></i> <span
                    ...
                    <DropdownItem className='p-0'>
                        <Link to="/blockedIps" className="dropdown-item">
                            <span className="align-middle">Blocked Ips</span>
                        </Link>
                    </DropdownItem>
                    <DropdownItem className='p-0'>
                        <Link to="/email-template" className="dropdown-item">
                            <span className="align-middle">                          Email Template</span>
                        </Link>
                    </DropdownItem>
                    <DropdownItem className='p-0'>
                        <Link to="/formbuilder/list" className="dropdown-item">
